...
final downloadLink:String = "https://spacebubble.io/apps/ezworksheet/app";
...
final programFolder = Sys.getEnv("HOME") + "/EZWorksheet/program";

function startDownloadWithSaveAndBar(progressBar:Shape) {
